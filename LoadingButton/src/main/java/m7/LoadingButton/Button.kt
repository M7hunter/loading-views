...
class Button @JvmOverloads constructor(
    ...
    private var tvLabel = AppCompatTextView(context).apply {
    ...
    private var pbLoading = ProgressBar(context).apply {
        layoutParams = FrameLayout.LayoutParams(
            LayoutParams.WRAP_CONTENT,
            0
        )
    ...
    init {
        ...
        context.theme.obtainStyledAttributes(attributeSet, R.styleable.LoadingButton, 0, 0)
            .use {
                ...
                setTextSize(
                    it.getDimension(R.styleable.LoadingButton_android_textSize, 0f),
                    true
                )
    ...
    fun setTextColor(color: Int = Color.WHITE) {
    ...
    fun setIsLoading(loading: Boolean) {
        ...
        pbLoading.visibility = if (loading) View.VISIBLE else View.GONE // loading
    }
